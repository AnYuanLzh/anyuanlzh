    ...
    <div class="bg-gray-50">
        ...
        <div class="p-2">
            <!-- <div class="text-center">
                致2021以前一直做的游戏开发工作。<br>
                这主要要用来练习: javascript css tailwindcss vue vuex
            </div> -->
            <div class="my-2 py-2">
            ...
            <h2 class="mt-6 font-bold">这个主页主要使用的web技术：</h2>
            <hr class="my-2" />
            <ul>
                <li>
                    <a 
            ...
            <ul>
                <li>
                    <a
                        target: _blank
                        href="https://blog.csdn.net/AnYuanLzh" class="lzh-a"
                        >在csdn上的博客</a
                    >
                    <p>
